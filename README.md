Ниже представлена объединенная документация, включающая основное описание проекта Safe-Net, детали стека (Next.js 16 + NestJS 10) и расширенную инструкцию по Docker-окружению.
