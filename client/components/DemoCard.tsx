	...
	return (
		...
		>
			...
			<div className='relative bg-slate-800 rounded-2xl shadow-2xl p-6 border border-slate-700'>
				...
				{/* Кнопка "Пройти ещё" появляется после ответа */}
				{isCorrect !== null && (
					<div className='mt-4'>
						<button
							onClick={openModal}
							className='w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium shadow-lg hover:scale-[1.01] transition-transform'
						>
...
function PasswordModal({ onClose }: { onClose: () => void }) {
	...
	return (
		<div className='fixed inset-0 z-50 flex items-center justify-center p-4'>
			...
			{/* Модальное окно — шире, ближе к обучающей платформе */}
			<motion.div
